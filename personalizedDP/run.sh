...
echo "=== EXPERIMENTO PERSONALIZED DP ==="
...
rm -f metrics_personalized.json server.log client_*.log
sleep 2
...
# Iniciar servidor
echo "🚀 Iniciando servidor Personalized DP na porta ${PORT}..."
...
# Iniciar clientes
echo "👥 Iniciando 4 clientes Personalized DP..."
for i in {0..3}; do
...
echo "=========================================="
echo "📊 Personalized DP em andamento..."
...
echo "✅ Experimento Personalized DP concluído!"
echo "📈 Métricas: metrics_personalized.json"

# Resultados
if [ -f "metrics_personalized.json" ]; then
    python3 -c "
import json
with open('metrics_personalized.json') as f:
    data = json.load(f)
print('📊 RESULTADOS PERSONALIZED DP:')
